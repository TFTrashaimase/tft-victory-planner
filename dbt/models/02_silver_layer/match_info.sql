...
SELECT DISTINCT
    ...
    SUBSTRING(json_data:info:tft_game_type, 1, LENGTH(json_data:info:tft_game_type) - 1) AS tft_game_type,
    SUBSTRING(json_data:info:tft_set_core_name, 1, LENGTH(json_data:info:tft_set_core_name) - 1) AS tft_set_core_name,
